<?php
	class claseDivBodyIncotermsDDU {
		public static function show() {
			...
			$DDU=$viaEmbarqueId=="0000000502"?$dduAereo:($viaEmbarqueId=="0000000493"?$dduMaritimo:$dduTerrestre);
		...
		public static function saveRecord() {
			...
			$arrayDDU	 = json_decode($dataObjectIncoterms,true);
			...
			$puertoOrigenId		=	$arrayDDU["PuertoOrigenId"];
			$puertoDestinoId	=	$arrayDDU["PuertoDestinoId"];
			$tipoCargaId		=	$arrayDDU["TipoCargaId"];
			$tipoMercaderiaId	=	$arrayDDU["TipoMercaderiaId"];
			$descMercaderia		=	$arrayDDU["DescMercaderia"];
			$infoAdicional		=	$arrayDDU["InfoAdicional"];
			$cantidadContenedor =	str_replace(",",".",$arrayDDU["CantidadContenedor"]);
			$tipoContenedorId	=	$arrayDDU["TipoContenedorId"];
			$descContenedor		=	$arrayDDU["DescContenedor"];
			$peso				=	str_replace(",",".",$arrayDDU["Peso"]);
			$pesoVolumen		=	str_replace(",",".",$arrayDDU["PesoVolumen"]);
			$volumen			=	str_replace(",",".",$arrayDDU["Volumen"]);
			$bultos				=	str_replace(",",".",$arrayDDU["Bultos"]);
			$unidadId			=	$arrayDDU["UnidadId"];
			$pesoVolumenId		=	$arrayDDU["PesoVolumenId"];
			$volumenId			=	$arrayDDU["VolumenId"];
			$embalajeId			=	$arrayDDU["EmbalajeId"];
			$dimensionBultos	=	$arrayDDU["DimensionBultos"];
			$claseImo			=	$arrayDDU["ClaseImo"];
			$un					=	$arrayDDU["Un"];
			$proveedorName		=	$arrayDDU["ProveedorName"];
			$provRecogidaDir	= 	$arrayDDU["ProvRecogidaDir"];
			$provEntregaDir		= 	$arrayDDU["ProvEntregaDir"];
			$navieraId			= 	$arrayDDU["NavieraId"];
			$valorMercaderia	= 	str_replace(",",".",$arrayDDU["ValorMercaderia"]);
			$valorFlete			= 	str_replace(",",".",$arrayDDU["ValorFlete"]);
			$partidaArancelaria	= 	$arrayDDU["PartidaArancelaria"];
			$subPartidaArancelaria	= 	$arrayDDU["SubPartidaArancelaria"];
			$coloaderDestino	= 	$arrayDDU["ColoaderDestino"];
			$cotizacion			=	$arrayDDU["Cotizacion"];
			$requerimiento		=	$arrayDDU["Requerimiento"];
			...
			$navieraName	= $obligatorio.$navieraName;
